...
it1 = Item.create!(name: 'Coca Cola Cherry Coke Soda - 2 Liter', description: 'Coca-Cola with cherry flavor and other natural flavors. Caffeine Content: 23 mg/8 fl oz. Very low sodium.', category_id: 1, price: '1.79', image: '108010252_100x100.jpg', store_id: 1)
it2 = Item.create!(name: 'Kelloggs Nutrigrain Cherry Snack Bar - 10.4 Oz', description: 'Naturally and artificially flavored. More of the whole grains your body needs (8 g whole grains). Good source of fiber. 3 g fat per serving. Made with real fruit. Whole Grain: 8 grams per serving. Eat 48 g or more of whole grains daily. One good decision', category_id: 2, price: '2.79', image: '111150326_100x100.jpg', store_id: 1)
it3 = Item.create!(name: 'Walkers Butter Cookie - 5.3 oz (150 g)', description: 'Walkers Butter Cookie - 5.3 oz (150 g)', category_id: 3, price: '1.09', image: '2/493A5C9.jpg', store_id: 2)
it4 = Item.create!(name: 'Nesquik Chocolate Milk - 40.7 Oz', description: '72 Servings. Looking for less sugar? Nesquik has 25% less sugar than other powder & syrup brands (13 g vs 19 g sugar/svg in other leading brands. This product contains 25 g of sugar when mixed with 1 cup of milk.). 99.9% Caffeine free.', category_id: 1, price: '5.79', image: '119020151_100x100.jpg', store_id: 3)
